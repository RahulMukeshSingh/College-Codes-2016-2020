...
public class geneticsTransportationMethods {
	public ArrayList<String> getInitialRoute(ArrayList<String> places, String first, String second) {
	...
	public ArrayList<geneticsStructure> replaceById(ArrayList<geneticsStructure> inputs, ArrayList<String> newRoutes,
			double[] distance, ArrayList<String> places, String first, String second) {
	...
	public ArrayList<ArrayList<String>> getMutation(ArrayList<String> newRoute, ArrayList<String> places, String first,
			String second) {
	...
	public void arrangement(int stopSameGeneration, String fileLocation, String first, String second) {
		...
		ArrayList<String> tempplacesonlyforsort = new ArrayList<String>();
		for (String p : places) {
			if (!p.equalsIgnoreCase(first) && !p.equalsIgnoreCase(second)) {
				tempplacesonlyforsort.add(p);
			}
		}
		...
		ArrayList<String> InitialRoutes = gtm.getInitialRoute(tempplacesonlyforsort, first, second);
		...
		inputs = gtm.replaceById(inputs, newRoute, totalDistance, places1, first, second);
		do {
			...
			ArrayList<ArrayList<String>> mutationPointsAnsRoutes = gtm.getMutation(newRoute, places1,first,second);
